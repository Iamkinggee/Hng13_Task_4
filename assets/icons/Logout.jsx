...
export default function Logout(props) {
  ...
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none">
    ...
    <Path d="M16.5001 16.5C16.5001 16.5 21 13.1858 21 12C21 10.8141 16.5 7.5 16.5 7.5M20 12L8.00003 12" stroke="currentColor"  stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" {...props}></Path>
</Svg>
  )
}
